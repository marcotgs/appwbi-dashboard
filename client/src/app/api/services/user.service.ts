...
import { LoginBody, ApiPayload, LoginResponse, ChangePasswordBody } from '@api/interfaces';
...
export default class UserService {
    ...
    public sendEmailChangePassword(body: ChangePasswordBody): Observable<ApiPayload<void>> {
