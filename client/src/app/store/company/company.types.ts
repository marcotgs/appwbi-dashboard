...
export const POST_COMPANY_ERROR = '[COMPANY] postCompany error';

export const DELETE_COMPANY = '[COMPANY] deleteCompany';
export const DELETE_COMPANY_SUCCESS = '[COMPANY] deleteCompany success';
export const DELETE_COMPANY_ERROR = '[COMPANY] deleteCompany error';
